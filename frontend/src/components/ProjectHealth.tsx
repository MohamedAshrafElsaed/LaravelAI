            ...
            <div className="max-w-4xl mx-auto p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div
                            className={`relative h-20 w-20 rounded-full flex items-center justify-center ${getScoreColor(health.score)} bg-gray-800 border-2 border-current`}>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span
                                className="text-2xl font-bold text-red-400">{health.issues_summary.by_severity.critical}</span>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span
                                className="text-2xl font-bold text-yellow-400">{health.issues_summary.by_severity.warning}</span>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span
                                className="text-2xl font-bold text-blue-400">{health.issues_summary.by_severity.info}</span>
                        </div>
                                                ...
                                                return (
                                                    <div key={issue.id} className="p-4 bg-gray-900/50">
                                                        <div className="flex items-start gap-3">
                                                            <div
                                                                className={`p-1.5 rounded ${severityColors[issue.severity]}`}>
                                                                ...
                                                                <div className="flex items-center gap-2 mt-3">
                                                                    ...
                                                                    {issue.auto_fixable && (
                                                                        <>
                                                                            <span className="text-gray-600">|</span>
                                                                            <span
                                                                                className="text-xs text-blue-400">Auto-fixable</span>
                                                                        </>
                                                                    )}
                                                                </div>
                                                            </div>
...
export function HealthScoreBadge({score}: { score: number | null | undefined }) {
    ...
    return (
        <span
            className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-medium border ${getColor()}`}>
