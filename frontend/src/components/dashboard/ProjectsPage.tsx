...
import {getErrorMessage, githubApi, GitHubRepo, Project, projectsApi} from '@/lib/api';
...
function HealthBadge({score}: { score?: number }) {
    ...
    return (
        <span
            className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${getColor(score)}`}>
...
function ProjectCard({project, onSelect, onDelete, viewMode}: ProjectCardProps) {
    ...
    if (viewMode === 'list') {
        return (
            ...
            >
                ...
                <AnimatePresence>
                    {showActions && (
                        ...
                        >
                            ...
                            >
                                {project.isDeleting ? <Loader2 className="w-4 h-4 animate-spin"/> :
                ...
                <ChevronRight
                    className="w-5 h-5 text-[var(--color-text-dimmer)] group-hover:text-[var(--color-primary)] transition-colors"/>
            </motion.div>
        );
    }
    ...
    return (
        ...
        >
            ...
            <div className="p-4 pb-3 border-b border-[var(--color-border-subtle)]">
                <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0">
                        <div
                            className="p-2 rounded-lg bg-[var(--color-primary-subtle)] group-hover:bg-[var(--color-primary)]/20 transition-colors">
            ...
            {/* Footer */}
            <div
                className="px-4 py-3 bg-[var(--color-bg-primary)]/50 border-t border-[var(--color-border-subtle)] flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    >
                        {project.isDeleting ? <Loader2 className="w-3.5 h-3.5 animate-spin"/> :
                ...
                >
                    ...
                    <div className="p-4 border-b border-[var(--color-border-subtle)]">
                        <div className="relative">
                            <Search
                                className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--color-text-dimmer)]"/>
                            <input
                                type="text"
                                value={search}
                                        ...
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {repo.private && (
                                                        <span
                                                            className="px-1.5 py-0.5 text-[10px] bg-amber-500/10 text-amber-400 rounded">
                                                            Private
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div
                                                    className="flex items-center gap-3 mt-1 text-xs text-[var(--color-text-dimmer)]">
                    ...
                    <div className="p-4 bg-[var(--color-bg-primary)]/50 border-t border-[var(--color-border-subtle)]">
                        <p className="text-xs text-[var(--color-text-dimmer)] text-center">
                            Only PHP and Laravel repositories are shown. Connect a repository to start AI-powered
                            development.
                        </p>
                    </div>
                </motion.div>
            ...
            >
                <div className="p-6">
                    ...
                    <p className="text-sm text-[var(--color-text-muted)] mb-6">
                        ...
                        className="font-medium text-[var(--color-text-primary)]">{project.name}</span>?
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-12 w-full max-w-2xl">
                {[
                    ...
                    <div key={i}
                         className="p-4 bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] rounded-xl">
        ...
        <div className="flex-1 p-6 overflow-y-auto">
            ...
            {projects.length > 0 && (
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                    ...
                    {/* View Toggle */}
                    <div
                        className="flex items-center gap-1 p-1 bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] rounded-lg">
                        <button
