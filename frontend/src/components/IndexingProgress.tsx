...
import {CheckCircle, FileCode, Loader2, RefreshCw, XCircle} from 'lucide-react';
...
export function IndexingBadge({
    ...
    return (
        <span
            className={`inline-flex items-center gap-1.5 rounded-full px-2 py-1 text-xs font-medium ${styles[status] || styles.pending}`}>
      {isInProgress && (
