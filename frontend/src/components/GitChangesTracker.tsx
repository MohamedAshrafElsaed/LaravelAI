...
import { gitChangesApi, GitChange, GitChangeFile } from '@/lib/api';
                  ...
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-[10px] px-1.5 py-0.5 rounded ${status.bgColor} ${status.color}`}>
                          {status.label}
                        </span>
                      </div>
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-400">
                      ...
                      {change.commit_hash && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-mono">{change.commit_hash.substring(0, 8)}</span>
                        </div>
                      )}
                    </div>
