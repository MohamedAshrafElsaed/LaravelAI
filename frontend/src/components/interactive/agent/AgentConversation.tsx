...
import {AlertCircle, ArrowRight, Check, ChevronRight, Loader2} from 'lucide-react';
import {AgentInfo, AgentThinkingState, AgentType, getAgentInfo, InteractiveEvent,} from './types';
            ...
            {entries.map((entry) => {
                ...
                switch (entry.type) {
                    ...
                    case 'system':
                        ...
                        return (
                            <div key={entry.id}
                                 className={`py-0.5 animate-fadeIn ${systemColors[entry.systemType || 'info']}`}>
