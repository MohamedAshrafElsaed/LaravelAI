...
import {DiffStats, DiffViewer} from './DiffViewer';
import {gitApi, GitChangeFile, gitChangesApi} from '@/lib/api';
...
export function ChangesReview({
    ...
    return (
        <div className="flex h-full flex-col bg-gray-950">
            {/* Header */}
            <div
                className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-800 px-4 py-3 gap-3">
