...
import {HealthScoreBadge, ProjectHealth} from '@/components/ProjectHealth';
...
export default function ProjectPage() {
    ...
    if (!project) {
        return (
            <div
                className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-gray-950 px-4">
    ...
    return (
        <div className="flex h-screen flex-col bg-gray-950 text-white overflow-hidden">
            {/* Header */}
            <header
                className="flex-shrink-0 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-800 bg-gray-900/80 backdrop-blur-sm px-4 py-3">
            ...
            `}
                    ...
                    <main className="flex flex-1 flex-col overflow-hidden">
                        {/* View Mode Tabs */}
                        <div
                            className="flex-shrink-0 flex items-center gap-1 border-b border-gray-800 bg-gray-900/50 px-2 overflow-x-auto">
                            <button
                ...
                <div className="flex flex-1 items-center justify-center p-4">
                    <div
                        className="max-w-md w-full rounded-2xl bg-gray-800/50 p-8 text-center backdrop-blur-sm border border-gray-700/50">
                        {project.status === 'error' ? (
                            ...
                            <>
                                <div className="relative mx-auto mb-6 h-16 w-16">
                                    <div
                                        className="absolute inset-0 animate-spin rounded-full border-4 border-blue-500/30 border-t-blue-500"/>
                  ...
                  <span className="relative flex h-2 w-2">
                    <span
                        className="absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-400 opacity-75"></span>
